...
namespace YogiBearWPF.Model
{
    ...
    public class YogiBearModel
    {
        ...
        public DispatcherTimer patrolling { get; set; } //vadőrök járőrözésének ideje
        public DispatcherTimer time { get; set; } //játékidő stopper
...
//        public System.Windows.Forms.Timer Patrolling { get { return patrolling; } }
        ...
        public YogiBearModel()
        {
            ...
            patrolling = new DispatcherTimer();
            patrolling.Interval = new TimeSpan(0, 0, 0, 0, 700);
        ...
        {
            time.Tick -= Time_Tick;
            patrolling.Tick -= Patrolling_Tick;
            map = new List<List<Int32>>();
            rangers = new List<Ranger>();
            baskets = 0;
            playerpos = new IntPoint(0, 0);
